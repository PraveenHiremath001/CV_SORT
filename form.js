...
// function for template display
function afterSubmiting()
{
   document.getElementById('displayResumeTemplate').classList.remove('hidden')
}
function displayResumeTemplate()
{
   document.getElementById('template-main-container').classList.remove('hidden');
   document.getElementById('progressive-cont').classList.add('hidden');
   document.getElementById('displayResumeTemplate').classList.add('hidden')
}

function backFromDownloadTemplate()
{
   document.getElementById('template-main-container').classList.add('hidden');
   document.getElementById('main-container').classList.remove('hidden')
   document.getElementById('Expirence-Form').classList.remove('hidden');
   document.getElementById('progressive-cont').classList.remove('hidden');
